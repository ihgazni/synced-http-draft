...
#define PERSISTENT_STRING(id, text) NanAssignPersistent<String>(id, NanNew<String>(text))
...
class CurlLib : ObjectWrap {
    ...
    public:
        ...
        static void Init(Handle<Object> target) {
            ...
            target->Set(NanNew<String>("CurlLib"),t->GetFunction());
    ...
    static NAN_METHOD(Run) {
        ...
        if (curl) {
            ...
            if (_body.length() > 0) {
                ...
                curl_easy_setopt(curl, CURLOPT_POSTFIELDSIZE,(curl_off_t)_body.length());
            }
